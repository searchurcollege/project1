<head>
    <title>Searchurcollege is online Educational Information classified and  practice test portal.</title>   
    <META NAME="Description" CONTENT="Searchurcollege is online educational information classified and  practice test portal. The students who want to  take admission for Further Study, Last Ten  Years Question Bank, Practice Test, Admission, Entrance Examination,Exam Information & college details. Our Portal with help."/>
    <META NAME="Keywords" CONTENT="Searchurcollege, Model Question Paper, Chapter Wise Set, Practice Test, Education, Colleges, Universities, Institutes, Career, Career Options, Career Prospects, Engineering, MBA, MEDICAL, LAW, DESIGN, Courses, Higher Education, Forum, Community, Education Career Experts, Ask Experts, Admissions, Results, Events, Scholarships"/>
</head>
<?php
...
<section class="study-section" id="Carouselb">
        <div class="tab-pills">
          <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" hhref="#study-one">Study In India</a></li>
